...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>Informes | Gestor Documental</title>
...
<body>
	...
	<div id="wrapper" class="wrapper">
		...
		<div class="main-container">
			...
			<div class="card-box mb-30">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalFormTitle">INFORME DE RADICADOS</h5>
				</div>
		...
		<script src="../core/informes.js?v=<?php echo time(); ?>"></script>
		<script src="../core/xlsx.mini.js?v=<?php echo time(); ?>"></script>
