...
$d = [
    ...
    */
    ...
    'ing16' => '$ 17.650.000',
    */
    'ing8'  => '$'.number_format($row['dec_TotalIngresos'],0,',','.'),
    'ing9'  => '$'.number_format($row['dec_IngresosFueraMunicipio'],0,',','.'),
    'ing10' => '$'.number_format($row['dec_TotalIngresos'] - $row['dec_IngresosFueraMunicipio'],0,',','.'),
    'ing11' => '$'.number_format($row['dec_IngresosDevoluciones'],0,',','.'),
    'ing12' => '$'.number_format($row['dec_IngresosExportaciones'],0,',','.'),
    'ing13' => '$'.number_format($row['dec_IngresosVentas'],0,',','.'),
    'ing14' => '$'.number_format($row['dec_IngresosActividades'],0,',','.'),
    'ing15' => '$'.number_format($row['dec_IngresosOtrasActividades'],0,',','.'),
    'ing16' => '$'.number_format($row['dec_BaseGravable'],0,',','.'),
    ...
    */
    ...
    'total_ingresos_gravados' => '$'.number_format($row['dec_BaseGravable'],0,',','.'),
    //'total_impuesto_gravado' => '$'.number_format($row['dec_ValorImpuesto'],0,',','.'),
    'total_impuesto_gravado' => '$'.number_format($totalImpuestoActividades,0,',','.'),
    ...
    'imp_ley56' => '$'.number_format($row['dec_ValorImpuesto'],0,',','.'),
...
/*
    ...
    */
    ...
    'saldo33' => '$'.number_format($row['dec_ValorConcepto12'],0,',','.'),
...
*/
    ...
    'total_saldo_favor' => '$'.number_format($row['dec_ValorConcepto13'],0,',','.'),
    'valor_pagar' => '$'.number_format($row['dec_ValorConcepto14'],0,',','.'),
    'descuento_pronto_pago' => '$'.number_format($row['dec_ValorConcepto15'],0,',','.'),
    'intereses_mora' => '$'.number_format($row['dec_ValorConcepto16'],0,',','.'),
    'total_a_pagar' => '$'.number_format($row['dec_ValorConcepto20'],0,',','.'),
    'pago_voluntario' => '$ 0',
    'total_con_pago_voluntario' => '$'.number_format($row['dec_ValorConcepto20'],0,',','.'),
...
.tituloPrincipal { font-size:10px; font-weight:bold; }
.titulo { font-size:11px; font-weight:bold; }
.subtitulo { font-size:4px; }
.pequeno { font-size:7px; }
...
$y_inicio = 12;
$y_fin = 81;
dibujarTextoVertical($pdf, 'A. INFORMACIÓN DEL CONTRIBUYENTE', $y_inicio, $y_fin);

// SECCCIÓN B
$y_inicio = 13;
$y_fin = 110;
dibujarTextoVertical($pdf, 'B. BASE GRAVABLE', $y_inicio, $y_fin);

// SECCCIÓN C
$y_inicio = 13;
$y_fin = 142;
dibujarTextoVertical($pdf, 'C. DISCR. ACTIVIDADES GRAVADAS', $y_inicio, $y_fin);

// SECCCIÓN D
$y_inicio = 13;
$y_fin = 185;
dibujarTextoVertical($pdf, 'D. LIQUIDACIÓN PRIVADA', $y_inicio, $y_fin);

// SECCCIÓN D
$y_inicio = 13;
$y_fin = 223;
dibujarTextoVertical($pdf, 'E. PAGO', $y_inicio, $y_fin);

// SECCCIÓN D
$y_inicio = 13;
$y_fin = 253;
dibujarTextoVertical($pdf, 'F. FIRMAS', $y_inicio, $y_fin);
