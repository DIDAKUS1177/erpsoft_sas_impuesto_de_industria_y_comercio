...
class ControladorDivipola extends \erpsoftsas\Cabecera {
    ...
    public static function run() {
        ...
        } catch (\erpsoftsas\BodegaException $e) {
            $con->rollback();
    ...
    **/ 
    private function _consultarDepartamentos() {
        ...
        $_objRol = new \erpsoftsas\DAO_Departamentos();
        if(isset($_POST['id'])){
    ...
    **/ 
    private function _consultarMunicipios() {
        ...
        $_objRol = new \erpsoftsas\DAO_Municipios();
        if(isset($_POST['id'])){
            if (!empty($_POST['id']) || $_POST['id'] != NULL ) {
...
class DivipolaException extends \Exception{}
    ...
    \erpsoftsas\ControladorDivipola::run();
