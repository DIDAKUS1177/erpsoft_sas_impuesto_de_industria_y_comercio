...
<div class="col-md-6">
    ...
    <label>
        <input type="checkbox" id="chkSinEstablecimiento">
        No tiene
    </label>
...
<div class="col-md-12" id="boxCeseActividades" style="display:none;">

    <div class="row">

        <div class="col-md-6">
            <label>Fecha de Cese</label>
            <input type="date" class="form-control" id="est_FechaCese">
        </div>

        <div class="col-md-6">
            <label>Documento Soporte (PDF)</label>
            <input type="file" class="form-control" id="est_PdfCese" accept="application/pdf">
        </div>
...
<input type="date" class="form-control" id="est_Fecha_inscripcion" name="est_Fecha_inscripcion" value="<?php echo date('Y-m-d'); ?>" readonly>
</div>
...
<th style="display:none;width:12%" class="text-center">
Año
</th>
...
-->
                            ...
                            <td>
                            <input type="text" class="form-control campo-total"
                            data-campo="sobretasa_bomberil" value="0">
                            </td>
                            </tr>
                            ...
                            <td>
                            <input type="text" class="form-control campo-total"
                            data-campo="menos_retenciones" value="0">
                            </td>
                            </tr>
                            ...
                            <td>
                            <input type="text" class="form-control campo-total"
                            data-campo="menos_autoretenciones" value="0">
                            </td>
                            </tr>
                            ...
                            <td>
                            <input type="text" class="form-control campo-total"
                            data-campo="anticipo_anterior" value="0">
                            </td>
                            </tr>
                            ...
                            <td>
                            <input type="text" class="form-control campo-total"
                            data-campo="anticipo_siguiente" value="0">
                            </td>
                            </tr>
<!--
<tr>
...
-->
                            ...
                            <td>
                            <input type="text" class="form-control campo-total"
                            data-campo="saldo_favor_vigencias_anteriores" value="0">
                            </td>
                            </tr>
                            ...
                            <td>
                            <input type="text" class="form-control campo-total"
                            data-campo="descuento_pronto_pago" value="0">
                            </td>
                            </tr>
                            ...
                            <td>
                            <input type="text" class="form-control campo-total"
                            data-campo="interes_mora" value="0">
                            </td>
                            </tr>
...
-->
                            ...
                            <table class="table table-bordered table-striped table-sm" id="tablaDeclaraciones">
                                <thead style="background:#e9ecef; font-weight:600;">
                                    <tr>
                                        ...
                                        <th style="width:80px;">Firmar Electronicamente</th>
                                        <th style="width:80px;">Pago PSE</th>
                                    </tr>
                                </thead>
    ...
    <!-- MODAL CESE DE ACTIVIDADES -->
        <div class="modal fade" id="modalCeseActividades" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">

                <div class="modal-header">
                    <h5 class="modal-title">Cese de Actividades</h5>
                    <button type="button" class="close" data-dismiss="modal">
                    <span>&times;</span>
                    </button>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <label>Fecha de Cese</label>
                    <input type="date" class="form-control" id="fechaCese">
                    </div>

                    <div class="form-group">
                    <label>Documento Soporte (PDF)</label>
                    <input type="file" class="form-control" id="pdfCese" accept="application/pdf">
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-success" id="btnGuardarCese">Guardar</button>
                </div>
