...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>Usuarios |Gestor Documental </title>
...
<body>
	...
	<div id="wrapper" class="wrapper">
			...
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content ">
					<div class="modal-header">
						<h5 class="modal-title" id="exampleModalFormTitle">Información del Contribuyente</h5>
									...
									<div class="row" >
										<div class="form-group" style="width: 95%">
											...
											<input type="text" class="form-control" id="usu_Apellidos" name="usu_Apellidos"
												maxlength="100" placeholder="Apellidos Completos" title='Ingrese Apellidos Completos' required>
										</div>	
									</div>
								</div>
								<div class="col-sm-12 col-md-6">
									<div class="row" >
										<div class="form-group" style="width: 95%">
											...
											<input type="text" class="form-control" id="usu_Telefono" name="usu_Telefono"
												maxlength="15" placeholder="Teléfono" title='Ingrese Número de Teléfono'>
										</div>	
									</div>
								</div>		
								<div class="col-sm-12 col-md-6">
		...
		<script src="../core/usuarios.js?v=<?php echo time(); ?>"></script>
