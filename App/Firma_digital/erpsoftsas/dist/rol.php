...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>Roles | GESTOR DOCUMENTAL</title>
					...
					<div class="col-lg-6 col-md-8 col-sm-12 mb-30 position-fixed" style="right:0;">
						<div class="card card-box">
							<div class="pd-20 card-header">
								...
								Dar clic en "Asignar Permisos" en cada modulo para guardar los cambios.
							</div>
							<div class="card-body">
								<form>
					...
					<form id="form-editRol">
						...
						<div class="modal-body">
							<div class="form-group">
								...
								<input type="text" maxlength="100" title='Máximo 100 Caracteres'class="form-control" placeholder="Descripción" id="txtDescripcion" required>
							</div>
						</div>			
