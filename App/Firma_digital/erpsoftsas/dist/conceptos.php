...
<body>
	...
	<div id="wrapper" class="wrapper">
		...
		<div class="main-container">
			...
			<div class="card-box mb-30" id="ltsRol">
				...
				<table id="conceptosRegistrados" class="data-table table stripe hover nowrap">
						...
						<tbody id="bodyConceptosRegistrados">
		...
		<!--Modal dependencia-->
		<div class="modal fade" id="modal-Conceptos" tabindex="-1" role="dialog" aria-labelledby="exampleModalFormTitle" aria-hidden="true">
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content ">
					<div class="modal-header">
						<h5 class="modal-title" id="exampleModalFormTitle">Conceptos</h5>
						<button type="button" class="close" data-dismiss="modal" aria-label="Close">
							<span aria-hidden="true">&times;</span>
						</button>
					</div>
					
					<form id="formCrearConceptos" class="" action="">
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <div class="row">
                                        <div class="form-group" style="width: 95%">
                                            ...
                                            <input type="text" class="form-control" 
                                                id="con_Observaciones" name="con_Observaciones" 
		...
		<script src="../core/conceptos.js?v=<?php echo time(); ?>"></script>
