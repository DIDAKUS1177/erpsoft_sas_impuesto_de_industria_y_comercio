...
class ControladorSubModulos extends \predial\Cabecera {
    ...
    public static function run() {
        ...
        } catch (\predial\SubModulosException $e) {
            $con->rollback();
    ...
    **/
    protected function _agregarSubModulos() {
        ...
        $_objSubModulos = new \predial\DAO_SubModulos();
        ...
        if($nomduplicado == 1){
            ...
            if(!$_objSubModulos->guardar()){
                ...
                $_objlogs = new logs();
                $_objlogs->_insertLogs($id,$_SESSION['id_usuario'],1,5);
                $this->_ok = 1;
    ...
    protected function _editarSubModulos() {
        ...
        if($nomduplicado == 1){
            ...
            if(!$_objSubModulos->guardar()){
                ...
                $id = $_objSubModulos->get_id();
                $_objlogs = new logs();
                $_objlogs->_insertLogs($id,4,$_SESSION['id_usuario'],4);
                $this->_ok = 1;
                $this->_mensaje = "Datos ingresados correctamente";
            }
            $return= $_objSubModulos->guardar();
    ...
    **/ 
    protected function _inactivarSubModulos() {
        ...
        if(!$_objSubModulos->guardar()){
            ...
            $id = $_objSubModulos->get_id();
            $_objlogs = new logs();
            $_objlogs->_insertLogs($id,5,$_SESSION['id_usuario'],4);
            $this->_ok = 1;
...
class SubModulosException extends \Exception{}
    ...
    \predial\ControladorSubModulos::run();
