...
class ControladorRol extends \erpsoftsas\Cabecera {
    ...
    public static function run() {
        ...
        } catch (\erpsoftsas\RolException $e) {
            //$con->rollback();
    ...
    */ 
    protected function _editarRol() {
        ...
        $nomRol = $_objRol->listarRegistros($_objRol->get_rol_Id());
