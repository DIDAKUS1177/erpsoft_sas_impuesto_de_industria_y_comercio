	...
	<table style="font-size:15px; text-align:center">
		<tr>
			...
			<td style="width:80px; font-size:10px">
				...
				<em style="width:130px;font-size:6px">
...
*/	
	...
	<table border="0.1" style="font-size:6px; text-align:center">
		<tr>
			<td style="width:140px;margin:auto;text-align:Center">
		...
		<tr>
			...
			<td style="width:90px;margin:auto;text-align:left">
	...
	<table border="0.1" style="font-size:6px; text-align:center">
		<tr>
			...
			<td style="width:30px;margin:auto;text-align:center">
				<b> BRUTO </b>
			</td>
			<td style="width:25px;margin:auto;text-align:center">
				<b> IVA </b>
			</td>
	...
	<table border="0.1" style="font-size:6px; text-align:center">
		<tr>
			<td style="width:80px;margin:auto;text-align:right">
				<b>DESCUENTOS</b>
			</td>
			<td style="width:60px;margin:auto;text-align:center">
				$ $descuento_format
			</td>
		</tr>
		<tr>
