...
*/
    ...
    async init(){
        try{
            ...
            if(postL.ok == 0){
                console.log('Error');
                    //$("#lbl-msg").show().html(json.mensaje);   
                //$("#usuario").val(json.mensaje);
                ...
                if(fechafull <= '2100-01-01'){
                    ...
                    sessionStorage.setItem('nom_empresa',postL.datos_usuario.strNombreEmpresa);
                    sessionStorage.setItem('nom_tipoImpresora',postL.datos_usuario.strTipoImpresora);
                    sessionStorage.setItem('nom_tipoFactura',postL.datos_usuario.strTipoFactura);
                    sessionStorage.setItem('nom_codigoEliminarProducto',postL.datos_usuario.strCodigoCaja);
    
                    //DATOS DE FACTARACION
                    sessionStorage.setItem('id_Bodega',postL.datos_usuario.strIdBodega);
                    sessionStorage.setItem('nom_Bodega',postL.datos_usuario.strNombreBodega);
                    sessionStorage.setItem('nom_Sede',postL.datos_usuario.strNombreSede);
                    sessionStorage.setItem('id_Sede',postL.datos_usuario.strIdSede);
                    sessionStorage.setItem('nom_Caja',postL.datos_usuario.strNombreCaja);
                    sessionStorage.setItem('id_caja',postL.datos_usuario.strIdCaja);
                    ...
                    if(permisos.ok == 1){
                        ...
                        if(postL.tipo_usuario == 1){
							...
							if(idRol != 1){
								...
								//window.location = 'dist/informeMorosos.php';
                                window.location = 'dist/exogenas.php';
							}
