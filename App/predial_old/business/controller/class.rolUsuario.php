...
class rolUsuario {
    ...
    public static function run() {
        ...
        } catch (\predial\RolUsuarioProyectosException $e) {
            $con->rollback();
    ...
    **/ 
    protected function _asignarRolUsuario($id_usuario, $id_rol) {
        ...
        $_objRolUsu = new \predial\DAO_rol_usuarios();
        ...
        if($_objRolUsu->guardar()){
            ...
            $_objLogs = new logs();
            $_objLogs->_insertLogs($id_rol_usuario,3,$_SESSION['id_usuario'],11);
            $this->_ok = 1;
    ...
    **/ 
    protected function _editarRolUsuario() {
        ...
        if($_objRolUsu->guardar()){
            $id_rol_usuario = $_objRolUsu->get_id();
            $_objlogs = new logs();
            $_objlogs->_insertLogs($id_rol_usuario,4,$_SESSION['id_usuario'],11);
            $this->_ok = 1;
            $this->_mensaje = "Datos ingresados correctamente";    
        }else{
            $this->_ok = 0;
