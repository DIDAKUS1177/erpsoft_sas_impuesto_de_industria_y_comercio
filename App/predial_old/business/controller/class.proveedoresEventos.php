...
include_once SERVER . '/business/DAO/DAO_ProveedoresEventos.php';
include_once SERVER . '/business/class.sessions.php';
include_once SERVER .'/business/controller/class.logs.php';

class ControladorProveedoresEventos extends \predial\Cabecera {
    ...
    */ 
    protected function _agregarProveedores() {
        ...
        $_objProveedores = new \predial\DAO_ProveedoresEventos();
        ...
        if(isset($_POST['idTipoCuenta'])){
            if (!empty($_POST['idTipoCuenta']) || $_POST['idTipoCuenta'] != NULL ) {
                $_objProveedores->set_prov_IdTipoCuenta($_POST['idTipoCuenta']);
            }   
        }

        if(isset($_POST['numeroCuenta'])){
            if (!empty($_POST['numeroCuenta']) || $_POST['numeroCuenta'] != NULL ) {
                $_objProveedores->set_prov_NumeroCuenta($_POST['numeroCuenta']);
            }   
        }

        if(isset($_POST['nombreBanco'])){
            if (!empty($_POST['nombreBanco']) || $_POST['nombreBanco'] != NULL ) {
                $_objProveedores->set_prov_NombreBanco($_POST['nombreBanco']);
            }   
        }
    ...
    */  
    private function _listarProveedores($id_Proveedores) {
        ...
        $con = \ConexionMysqlUsuariosCentral\ConexionSQL::getInstance();
        $query = "SELECT * FROM eve_proveedoreseventos WHERE prov_Id <> $id_Proveedores ";
...
class ProveedoresEventosException extends \Exception{}

    \predial\ControladorProveedoresEventos::run();
