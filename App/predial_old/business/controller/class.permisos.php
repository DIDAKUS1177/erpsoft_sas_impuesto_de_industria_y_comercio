...
class ControladorPermisos extends \predial\Cabecera {
    ...
    public static function run() {
        ...
        } catch (\predial\PermisosException $e) {
            $con->rollback();
    ...
    **/
    private function _ingresarPermisos() {
        ...
        if($this->_eliminarPermisos($_POST['id_rol']) == 1){
            ...
            $_objlogs = new logs();
            $_objlogs->_insertLogs($_POST['id_rol'],$_SESSION['id_usuario'],1,5);
        }       
        return $return;
    }         
    ...
    **/ 
    protected function _agregarPermisos($id_rol,$id_modulo,$id_sub_modulo) {
        ...
        $_objPermiso = new \predial\DAO_Permisos();
        ...
        if(!$_objPermiso->guardar()){
            ...
            //$_objlogs = new logs();
            //$_objlogs->_insertLogs($id_rol,$_SESSION['id_usuario'],1,5);
            $return= 1;
            //$this->_ok = 1;
    ...
    **/
    protected function _inactivarPermisos() {
        ...
        if(!$_objPermiso->guardar()){
            ...
            $id = $_objPermiso->get_per_Id();
            $_objlogs = new logs();
            $_objlogs->_insertLogs($_SESSION['id_usuario'],$id,1,5);
            $this->_ok = 1;
...
class PermisosException extends \Exception{}
    ...
    \predial\ControladorPermisos::run();
