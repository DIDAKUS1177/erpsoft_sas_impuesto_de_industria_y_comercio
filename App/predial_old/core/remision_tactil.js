    ...
    getProducto() {
        ...
        $.ajax({
            ...
            success: function(arr) {
                ...
                //$("#bodyProductosTactil").empty();
                if (arr.ok == 1) {
                    
                    

                    for (let d of arr.datos) {
                        $("#bodyProductosTactil").append(
                            '<tr>' +
                            
                            '<td> <button type="button" nombreProducto ="' + d.pro_Nombre + '" name="detkar_IdProducto" id="detkar_IdProducto"  value="' + d.pro_Id + '" class="btn btn-primary" onclick="nota.cargarPrecios()">' + d.pro_Nombre + '</button> </td>' +
