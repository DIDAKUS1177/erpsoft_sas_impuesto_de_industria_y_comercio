...
class Proveedores {
    ...
    draw_table_documents(arrFilter) {
        ...
        for (let bod of arrFilter) {
            ...
            $('#tbodyProveedores').append(
                ...
                '<td align="center">' +
                '<button type="button" class="mb-1 btn btn-social-icon btn-warning " data-toggle="tooltip" title="Editar Eventos" style="margin-right:5px" onclick="javascript:bod.getProveedoresById(' + bod.prov_Id + ')">' +
                ...
                success: function(arr) {
                    ...
                    if (arr.ok == 1) {
                        for (let datos of arr.datos) {
                            ...
                            $("#selec_IdTipoCuenta").val(datos.prov_IdTipoCuenta);
                            $("#numeroCuenta").val(datos.prov_NumeroCuenta);
                            $("#nombreBanco").val(datos.prov_NombreBanco);
    ...
    putProveedores(id) {
        ...
        var idTipoCuenta = $("#selec_IdTipoCuenta").val();
        ...
        $.ajax({
            ...
            data: { funcion: 2, idpro: id, nombre: nombre, razonSocial: razonsocial, nit: nit, direccion: direccion,
                ...
                idTipoPersona: idTipoPersona, idTipoCuenta: idTipoCuenta, numeroCuenta: numeroCuenta, nombreBanco: nombreBanco},
            dataType: "json",
            type: "POST",
            success: function(arr) {
    ...
    ProveedoresActivo() {
        ...
        $("#SubMenuProveedoresEventos").addClass('active');
    }
