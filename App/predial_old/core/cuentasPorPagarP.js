...
class Nota {
    ...
    draw_table_documents(arrFilter) {
        ...
        for (let not of arrFilter) {
                ...
                var totalValorProveedor = totalValorProveedor + parseInt(not.totalFacturas) ;
                ...
                //    '</td>' +
                 ...
                 //   '</td>' +
                    ...
                    '<td>' +
                    //not.totalFacturas +
                    '$ '+ Number(parseInt(not.totalFacturas).toFixed(0)).toLocaleString('es-CO') +
                    '</td>' +
/*
                    '<td>' +
                    totalAbonos +
...
//        var permiso = await _permisos.getPermisos(idRol, 521);
    ...
    NotaActivo() {
        ...
        $("#SubMenuCuentasPorPagarP").addClass('active');
    }
