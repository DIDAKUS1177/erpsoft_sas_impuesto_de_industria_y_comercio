...
<body>
	...
	<div id="wrapper" class="wrapper">
						...
						<div class="row container">
							<div class="col-sm-12 col-md-6">
								<h4 class="h3">Listado de Predios</h3>
									<br>
									<p>Seleccionar año a consultar de predios con deuda que no se ha generado Documentación.</p>
							...
							<div class="col-sm-12 col-md-6">
								<div class="row" >
									...
									<h4 class="h3"> Rango de Año</h3>
									<br>
									<p>Seleccionar hasta que año de deuda se genera de Documentación.</p>
		...
		<script src="../core/listadoPredios.js"></script>
