		...
		<div class="main-container">
			...
			<div class="card-box mb-30">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalFormTitle">INFORME DE MOROSOS</h5>
				</div>
						...
						<div class="col-sm-12">
							<div class="row">
								...
								<label>MODULO <span class="require">*</span></label>
									...
									tabindex="-1" aria-hidden="true" id="mod_IdModuloMorosos" name="mod_IdModuloMorosos" required></select>
								</div>
								<br>
								<div class="form-group; col-sm-4" style="width: 100%">		
									<div class="form-group; col-sm-12" style="width: 100%">
										<label id="labelUltimoAnio"  name="labelUltimoAnio"> Año Inicial a Consultar <span class="require"></span></label>
								...
								<div class="form-group; col-sm-4" style="width: 100%">		
									<div class="form-group; col-sm-12" style="width: 100%">
										<label id="labelUltimoAnio"  name="labelUltimoAnio"> Año Final a Consultar <span class="require"></span></label>
										<select id="id_anioPagoFinal" name="id_anioPagoFinal" class="form-control" required>
										</select>
									</div>
								</div>	
