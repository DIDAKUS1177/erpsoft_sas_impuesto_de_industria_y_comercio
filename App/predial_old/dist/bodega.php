...
<body>
	...
	<div id="wrapper" class="wrapper">
		...
		<div class="main-container">
			...
			<div class="card-box mb-30" id="ltsRol">
				<div class="pd-20 d-flex justify-content-between">
					<h4 class="h4">Listado de bodegas</h4>
					<button type="button" class="btn btn-outline-success" onclick="bod.crearBodega()"><span class="ti-plus"></span> Crear Bodega</button>
				</div>
				<div class="pb-20">
		...
		<script src="../core/bodega.js"></script>
