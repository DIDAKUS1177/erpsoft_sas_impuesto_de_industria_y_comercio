...
<body>
	...
	<div id="wrapper" class="wrapper">
								...
								<div class="row" >
									<div class="form-group" style="width: 95%">
										<label>*Codigo del Predio</label>
											<input type="number" class="form-control" id="cod_predio" name="cod_predio"
											<?php
											if(isset($_POST["cod_predio"])){
												echo'value ='.$_POST["cod_predio"].'';
											}
											?>
											 required>
									</div>
		...
		<script src="../core/hojadeVida.js"></script>
