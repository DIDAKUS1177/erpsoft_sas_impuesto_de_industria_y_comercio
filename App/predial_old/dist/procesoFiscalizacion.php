		...
		<div class="main-container">
			...
			<div class="card-box mb-30">
				<div class="pd-20 d-flex justify-content-between" style="margin-top: 1%">
					<h4>  PROCESO DE FISCALIZACIÓN </h4>
				</div>
				...
				<form id="formCrearEventos" class="" action="" method='post'>
					<div class="modal-body">
						<div class="row container">
							...
							<button type="button"  id="1" style="margin-right: 1%" class="btn btn-outline-success button" onclick="nota.getNotas(1),toggleActive(this)"></span> Investigación</button>
							<button type="button" id="2" style="margin-right: 1%" class="btn btn-outline-success button" onclick="nota.getNotas(2),toggleActive(this)"></span> Factura</button>
							<button type="button" id="3" style="margin-right: 1%" class="btn btn-outline-success button" onclick="nota.getNotas(3),toggleActive(this)"></span> Publicación</button>			
							<button type="button" id="4" style="margin-right: 1%" class="btn btn-outline-success button" onclick="nota.getNotas(4),toggleActive(this)"></span> Constancia</button>
							<button type="button" id="5" style="margin-right: 1%" class="btn btn-outline-success button" onclick="nota.getNotas(5),toggleActive(this)"></span> Mandamiento</button>
							<button type="button" id="6" style="margin-right: 1%" class="btn btn-outline-success button" onclick="nota.getNotas(6),toggleActive(this)"></span> AutoArchivo</button>
...
-->	
				...
				<div style="display: flex; gap: 10px;">
					<button type="button" class="btn btn-outline-success" id="botonEstadoCambiarAtras" onclick="nota.crearDocumentosAtras()"> Devolver de Estado </button>	
					<button type="button" class="btn btn-outline-success" id="botonEstadoCambiar" onclick="nota.crearDocumentos()"> Cambiar de Estado </button>
					<button type="button" class="btn btn-outline-success" id="botonAutoArchivo" onclick="nota.crearDocumentosAutoArchivo()"> Auto Archivo </button>
				</div>
			</div>
		</div>
		...
		<div class="modal fade" id="modal-Precios" tabindex="-1" role="dialog" aria-labelledby="exampleModalFormTitle" aria-hidden="true">
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content ">
					<div class="modal-header">
						<h5 class="modal-title" id="exampleModalFormTitle">Datos de VUR</h5>
						<button type="button" class="close" data-dismiss="modal" aria-label="Close">
							<span aria-hidden="true">&times;</span>
						</button>
					</div>
						...
						<div class="modal-body">
							<div class="row container">
								...
								<div class="col-sm-12 col-md-12" style="margin-top: 1%">
									<div class="row">
										<div class="form-group" style="width: 95%">
											<label>Folio de Matricula</label>
											<input type="text" class="form-control" id="pre_Folio" name="pre_Folio" required>
										</div>	
									</div>	
								</div>
								...
								<div class="col-sm-12 col-md-12" style="margin-top: 1%">
									<div class="row">
										<div class="form-group" style="width: 95%">
											<label for="comentarios">Observaciónes:</label>
    										<textarea id="pre_Observaciones" name="pre_Observaciones"class="form-control" rows="4" cols="50" 
		...
		<script src="../core/procesoFiscalizacion.js"></script>
...
<script>
  function toggleActive(button) {
        ...
        // Agrega la clase 'active' solo al botón seleccionado
        button.classList.add('active');
    }

    // Función para activar un botón por su ID
    function activateButtonById(buttonId) {
