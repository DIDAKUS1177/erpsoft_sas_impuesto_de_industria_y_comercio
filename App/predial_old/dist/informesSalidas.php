...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>Informes Egresos | DS-POS</title>
		...
		<div class="main-container">
			...
			<div class="card-box mb-30">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalFormTitle">INFORME PAGOS DE CAJA (PAGOS, GASTOS, COMPRAS)</h5>
				</div>
						...
						<div class="col-sm-12">
							<div class="row">
								<div class="form-group; col-sm-3" style="width: 100%">
									...
									tabindex="-1" aria-hidden="true" id="mod_IdModuloPagosCaja" name="mod_IdModuloPagosCaja" required></select>
								</div>	
								<div class="form-group; col-sm-3" style="width: 100%">
									<label>CAJA <span class="require">*</span></label>
									<select class="form-control" style="width: 100%;"
									tabindex="-1" aria-hidden="true" id="txtidCaja" name="txtidCaja" required></select>
								</div>
								<div class="form-group; col-sm-3" style="width: 100%">
									<label>CATEGORIA <span class="require">*</span></label>
									<select class="form-control" style="width: 100%;"
									tabindex="-1" aria-hidden="true" id="txtidCategoria" name="txtidCategoria" required></select>
								</div>	
								<div class="form-group; col-sm-3" style="width: 100%">
									<label>SUBCATEGORIA <span class="require">*</span></label>
									<select class="form-control" style="width: 100%;"
									tabindex="-1" aria-hidden="true" id="txtidSubCategoria" name="txtidSubCategoria" required></select>
								</div>	
								<br> 
								<div class="form-group; col-sm-3" style="width: 100%">
								...
								<div id="fechaInicial" class="form-group; col-sm-3" style="width: 100%">
									...
									<input type="date" class="form-control" placeholder="Ingrese Fecha" id="txtFechaInicioPagos"  name="txtFechaInicioPagos">
								...
								<div id="fechaFinal" class="form-group; col-sm-3" style="width: 100%">
									...
									<input type="date" class="form-control" placeholder="Ingrese Fecha" id="txtFechaFinalPagos"  name="txtFechaFinalPagos" >
