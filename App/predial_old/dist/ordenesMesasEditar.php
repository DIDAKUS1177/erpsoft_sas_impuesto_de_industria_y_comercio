...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>Editar Ordenes | DS-POS</title>
								...
								<div class="col-sm-12">
									<div class="row">
										...
										<div class="form-group; col-sm-2" style="width: 100%">
											...
											<input type="hidden" class="form-control" value="<?php echo $_GET["codigo"]; ?>" name="idOrdenEditar" id="idOrdenEditar" readonly>
											<input type="hidden" class="form-control" value="<?php echo $_GET["idMesa"]; ?>" name="idMesa" id="idMesa" readonly>
            								<input type="hidden" class="form-control" value="<?php echo $_GET["idSede"]; ?>" name="idFormaPago" id="idFormaPago" readonly>        

										</div>

										<div class="form-group; col-sm-2" style="width: 100%">
											<label><strong>SEDE</strong><span class="require"></span></label>
...
-->										
										<div class="form-group; col-sm-2" style="width: 100%">
												...
												<input type="hidden" class="form-control" id="id_Sede" name="id_Sede" style="text-align: center;" readonly>										
										...
										<div class="form-group; col-sm-6" style="width: 100%">
												<label><strong>Mesas Disponibles</strong><span class="require">*</span></label>
													<select class="custom-select2 form-control" style="width: 50%;"
													tabindex="-1" aria-hidden="true" id="doc_IdMesa" name="doc_IdMesa" required></select>
									...
									<div class="row">
										<div role="documentt" class="col-sm-4">
												...
												<tbody>
													<tr>
														...
														<td style="width: 45%">
															...
															<input type="hidden" class="form-control" id="detkar_TipoProduc" name="detkar_TipoProduc" style="text-align: center;" value = "0">
											...
											<div class="form-group;" style="width: 100%">
												<label>Observaciónes Generales<span class="require"></span></label>
									...
									<div class="col-sm-12">
										<div class="row">
											...
											<div class="form-group; col-sm-3" style="width: 100%">
											    <input type="hidden" class="form-control" id="valor_dado" name="valor_dado" style="text-align: center;" onfocus="nota.cargarCalculadora(2,0);" required>
												<input type="hidden" class="form-control" id="valor_dado" name="valor_dado" value="0"  style="text-align: center;"required> 
											</div>


											<div class="form-group; col-sm-2" style="width: 100%">
												<input type="hidden" class="form-control" id="descuento" name="descuento" value="0" style="text-align: center;" onChange="nota.aplicarDescuentoTotal()">										
												<input type="hidden" class="form-control" id="valor_dado" name="valor_dado" value="0"  style="text-align: center;"required>  
											</div>
<!--
											<div class="form-group; col-sm-8" style="width: 100%">
												<label>Observaciónes Generales<span class="require"></span></label>
												<textarea type="text" class="form-control" id="observaciones" name="observaciones" ></textarea>
											</div>
-->
											<div class="form-group; col-sm-4" style="width: 100%">
												<div class="form-group; col-sm-12" style="width: 100%">
													<input type="hidden" size="8"  id="subtotalocul" name="subtotalocul" style="text-align: left; border: 0" readonly>
												</div>
												<div class="form-group; col-sm-12" style="width: 100%">
													<input type="hidden" size="8" id="totalBrutoVisual" name="totalBrutoVisual" style="text-align: left; border: 0" readonly>
												</div>
												<div class="form-group; col-sm-12" style="width: 100%">
													<input type="hidden" size="8" id="totalImpuestosVisual" name="totalImpuestosVisual" style="text-align: left; border: 0" readonly>
												</div>
												<div class="form-group; col-sm-12" style="width: 100%">
													<input type="hidden" size="8"  id="descuentofacturavisual" name="descuentofacturavisual" value="0" style="text-align: left; border: 0" readonly>
												</div>
												<div class="form-group; col-sm-12" style="width: 100%">
													<input type="hidden" size="8"  id="redondeo" name="redondeo" value="0" style="text-align: left; border: 0" readonly>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="col-sm-12">
										<div class="row">
											<div class="form-group; col-sm-8" style="width: 100%;text-align: center">
												<label><strong>ORDENES DE MESAS </strong><span class="require"></span>												
											</div>
		...
		<!--Modal Calculadora-->
		<div class="modal fade bd-example-modal-lg" id="printSection" role="dialog" aria-labelledby="exampleModalFormTitle" aria-hidden="true">
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content">
		...
		<!--Modal Rol-->
		<div class="modal fade" id="modal-ValidarCodigo" tabindex="-1" role="dialog" aria-labelledby="exampleModalFormTitle" aria-hidden="true">
			<div class="modal-dialog modal-sm" role="document">
				<div class="modal-content ">
					<div class="modal-header">
						<h5 class="modal-title" id="exampleModalFormTitle">Validar Clave</h5>
						<button type="button" class="close" data-dismiss="modal" aria-label="Close">
							<span aria-hidden="true">&times;</span>
						</button>
					</div>
					
					<form id="formValidarCodigo" class="" action="">
						<div class="modal-body">
								...
								<div class="col-sm-12 col-md-12">
									<div class="row" >
										<div class="form-group" style="width: 95%">
											<label>*CLAVE</label>
											<input type="password" class="form-control" id="mar_codigoCaja" name="mar_codigoCaja" required>
										</div>	
									</div>	
								</div>
							</div>
						...
						<div class="modal-footer" id="modal_footer">
							...
							<button type="submit" class="btn btn-success btn-pill" id="btnValidarCodigo">
								Validar
							</button>
						</div>
		...
		<script src="../core/ordenesMesasActivasEditar.js"></script>
