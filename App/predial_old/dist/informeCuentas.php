		...
		<div class="main-container">
			...
			<div class="card-box mb-30">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalFormTitle">INFORME CUENTAS</h5>
				</div>
						...
						<div class="col-sm-12">
							<div class="row">
								<div class="form-group; col-sm-4" style="width: 100%">
									...
									tabindex="-1" aria-hidden="true" id="mod_IdModuloCuentas" name="mod_IdModuloCuentas" onclick="nota.getActivarCuentas()" required></select>
										<div class="form-group; col-sm-12" style="width: 100%">
											<label> NOMBRE CUENTA <span class="require"></span></label>									
											<select id="id_cuentas" name="id_cuentas" class="form-control" required>
			...
			<div class="card-box mb-30">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalFormTitle">INFORME CUENTAS POR PAGAR</h5>
				</div>

				<form id="formGenerarInforme" method="post" action="../business/controller/class.informesCuentasPorPagar.php">
					<div class="modal-body" style="text-align: center">
						<div class="col-sm-12">
							<div class="row">
								<div class="form-group; col-sm-4" style="width: 100%">
									<label>Estado Cuentas <span class="require">*</span></label>
									<select class="form-control" style="width: 100%;"
									tabindex="-1" aria-hidden="true" id="cupa_EstadoCuenta" name="cupa_EstadoCuenta" required>
									<option value="0">No Saldadas</option>
									<option value="1">Saldadas</option></select>
								</div>	
								<br> 
								<div class="form-group; col-sm-3" style="width: 100%">
									<label>FECHA INICIAL<span class="require"></span></label>
