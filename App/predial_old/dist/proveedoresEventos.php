...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>Proveedores Eventos | predial</title>
...
<body>
	...
	<div id="wrapper" class="wrapper">
		...
		<div class="main-container">
			...
			<div class="card-box mb-30" id="ltsRol">
				<div class="pd-20 d-flex justify-content-between">
					<h4 class="h4">Listado de Proveedores de Eventos</h4>
								...
								<div class="col-sm-12 col-md-4" >
									<div class="row">
										<div class="form-group" style="width: 95%">
											...
											<select class="form-control" id="selec_IdTipoCuenta" name="selec_IdTipoCuenta">
											<option value="">Seleccione un Tipo Cuenta</option>
								...
								<div class="col-sm-12 col-md-4" >
									<div class="row">
										<div class="form-group" style="width: 95%">
											...
											<input type="number" class="form-control" placeholder="" id="numeroCuenta" name="numeroCuenta">
										</div>	
									</div>	
								</div>
								...
								<div class="col-sm-12 col-md-4" >
									<div class="row">
										<div class="form-group" style="width: 95%">
											...
											<input type="text" class="form-control" placeholder="" id="nombreBanco" name="nombreBanco">
										</div>	
									</div>	
								</div>
		...
		<script src="../core/proveedoresEventos.js"></script>
