...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>Factura POS | DS-POS</title>
											...
											<table name="tablaDatos" class="table hover nowrap table-responsive">
												...
												<tbody>
													<tr>
														...
														<td style="width: 45%">
															<select class="custom-select2 form-control" style="width: 100%;" tabindex="-1" aria-hidden="true" id="detkar_IdProducto" name="detkar_IdProducto" onchange="nota.cargarPrecios()"autofocus>
															</select>
									...
									<div class="col-sm-12">
										<div class="row">
											<div class="form-group; col-sm-3" style="width: 100%">
												...
												<button type="button" class="btn btn-outline-success" onclick="nota.verMesas()"> ORDENES DE MESAS</button>
											</div>
<!--
											<div class="form-group; col-sm-3" style="width: 100%">
...
-->
											<div class="form-group; col-sm-2" style="width: 100%">
												...
												<input type="hidden" class="form-control" id="idMesaActiva" value='0' name="idMesaActiva">
									...
									<div class="col-sm-12">
										<div class="row">
											<div class="form-group; col-sm-8" style="width: 100%;text-align: center">
												<label><strong>	FACTURACIÓN POS</strong><span class="require"></span>
											</div>
		...
		<div class="modal fade" id="modal-Mesas" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-dialog-scrollable modal-lg">
				<div class="modal-content">
					<div class="modal-header">
						<h4 class="modal-title" id="tituloModalRol">Mesas</h4>
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
					</div>
					<form id="form-verMesas">
						<div class="modal-body">
