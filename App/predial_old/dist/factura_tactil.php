									...
									<div class="row">
										...
										<div class="form-group; col-sm-3" style="width: 100%">
												<label><strong>CLIENTE</strong><span class="require">*</span></label>
													...
													<input type="text" id="campo_personalizado" name="campo_personalizado" style="text-align:center">
										</div>
									</div>	
								</div>
...
<!--  SECCION DE SELECCIÓN PE PRODUCTOS Y LISTADO DE PRODUCTOS FACTURADOS     -->
								<div class="col-sm-12">
									<div class="row">
										<div id="tablaTatil" name='tablaTatil'role="documentt" class="col-sm-4">
		...
		<script src="../core/factura_tactil.js"></script>
