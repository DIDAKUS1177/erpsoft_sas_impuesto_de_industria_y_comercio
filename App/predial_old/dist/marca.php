...
<body>
	...
	<div id="wrapper" class="wrapper">
		...
		<div class="main-container">
			...
			<div class="card-box mb-30" id="ltsRol">
				<div class="pd-20 d-flex justify-content-between">
					<h4 class="h4">Listado de Marcas de Productos</h4>
					<button type="button" class="btn btn-outline-success" onclick="marca.crearMarca()"><span class="ti-plus"></span> Crear Marca</button>
				</div>
				<div class="pb-20">
				<table id="marcasRegistrados" class="data-table table stripe hover nowrap">
						<thead>
							<tr>
								<th>Nombre</th>							
								<th>Acciones</th>
						...
						<tbody id="bodyMarcasRegistrados">
		...
		<!--Modal Rol-->
		<div class="modal fade" id="modal-Marca" tabindex="-1" role="dialog" aria-labelledby="exampleModalFormTitle" aria-hidden="true">
					<div class="modal-dialog modal-lg" role="document">
						<div class="modal-content ">
							...
							<form id="formCrearMarca" class="" action="">
		...
		<script src="../core/marca.js"></script>
