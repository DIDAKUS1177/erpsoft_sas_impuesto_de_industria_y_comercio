...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>Cuentas por Pagar Saldadas | DS-POS</title>
...
<body>
	...
	<div id="wrapper" class="wrapper">
		...
		<div class="main-container">
			...
			<div class="card-box mb-30">
				<div class="pd-20 d-flex justify-content-between" style="margin-top: 1%">
					<h4 class="h4">Listado de Cuentas por Pagar Saldadas</h4>
			...
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content ">
					<div class="modal-header">
						<h5 class="modal-title" id="exampleModalFormTitle">Crear Abono a Cuenta por Pagar</h5>
		...
		<script src="../core/cuentasPorPagarSaldadas.js"></script>
