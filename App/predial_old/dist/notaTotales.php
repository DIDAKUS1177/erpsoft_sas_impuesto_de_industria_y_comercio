	...
	<div id="wrapper" class="wrapper">
		...
		<div class="modal fade" id="modal-Detalles"  role="dialog" aria-labelledby="exampleModalFormTitle" aria-hidden="true">
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content ">
					<div class="modal-header">
						<h5 class="modal-title" id="exampleModalFormTitle">Detalles Entradas / Salidas</h5>
						<button type="button" class="close" data-dismiss="modal" aria-label="Close">
							<span aria-hidden="true">&times;</span>
						</button>
					</div>
							...
							<table id="ltsDetallesNota" class="table table-responsive hover nowrap">
								<thead>
									<tr>
										<th>Producto</th>
										<th>Bodega</th>
										<th>Cant Entrada por Compras</th>
										<!--<th>Valor Entrada</th>-->
										<th>Cant Salida por Ventas</th>
										<!--<th>Valor Salida</th>
										<th>Cant Saldo</th>
										<th>Valor Saldo</th>-->
									</tr>
		...
		<script src="../core/notaTotales.js"></script>
