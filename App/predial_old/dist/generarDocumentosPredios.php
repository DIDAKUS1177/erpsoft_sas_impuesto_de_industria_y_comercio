...
<body>
	...
	<div id="wrapper" class="wrapper">
								...
								<div class="col-sm-12 col-md-6" style="margin-top: 1%">
									<div class="row">
										<div class="form-group" style="width: 95%">
											<label>*Codigo Predial Inicial</label>
											<input type="number" class="form-control" id="emp_Nsombre" name="emp_Nombr1e" value='0000000000010009000000000' required>
										</div>	
									</div>	
								</div>
								<div class="col-sm-12 col-md-6" style="margin-top: 1%">
									<div class="row">
										<div class="form-group" style="width: 95%">
											<label>*Codigo Predial Final</label>
											<input type="number" class="form-control" id="emp_NombreCosmercial" name="emp_Nombr1eComercial" value='0000000000010009000000000' required>
										</div>	
									</div>	
								</div>							
		...
		<script src="../core/generarDocumentosPredios.js"></script>
