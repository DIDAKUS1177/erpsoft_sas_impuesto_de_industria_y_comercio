...
<!--  SECCION DE SELECCIÓN PE PRODUCTOS Y LISTADO DE PRODUCTOS FACTURADOS     -->
								<div class="col-sm-12">
									<div class="row">
										<div  id="tablaTatil" name='tablaTatil' role="documentt" class="col-sm-12">
											<table name="tablaDatosTactil" id="tablaDatosTactil" class="table table-sm hover stripe nowrap">
												<thead>
													<tr>
														<th>Cantidad</th>
														<!--<th>Descuento</th>-->
										...
										<div role="documentt" class="col-sm-4">
											<table  name="notasRegistradass" id="notasRegistradass" class="data-table table stripe hover nowrap">
												<thead>
													<tr>
														<th>PRODUCTOS</th>
													</tr>
												</thead>
												<tbody id="bodyNotasRegistradass">
...
-->
		...
		<script src="../core/facturacion_tactil.js"></script>
