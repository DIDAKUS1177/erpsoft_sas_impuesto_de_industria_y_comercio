...
$row->addCell(1000)->addText($diaDoc ,$fuenteDosTituloDos, array('align'=>'center','spaceBefore' => 0, 'spaceAfter' => 0));
$row->addCell(1000)->addText($mesDoc,$fuenteDosTituloDos, array('align'=>'center','spaceBefore' => 0, 'spaceAfter' => 0));
$row->addCell(1000)->addText($anioDoc,$fuenteDosTituloDos, array('align'=>'center','spaceBefore' => 0, 'spaceAfter' => 0));
...
$row->addCell(6000, array('gridSpan' => 1, 'vMerge' => 'restart'))->addText($nombreDirector, $fuenteTituloTres, array('align'=>'center','spaceBefore' => 0, 'spaceAfter' => 0));
