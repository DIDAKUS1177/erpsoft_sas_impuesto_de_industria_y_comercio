...
$stmt = sqlsrv_query( $conn, $query );
    ...
    $fechaFactura = $row[0]['fechaFactura'];
...
$row = $tabla->addRow();
$row->addCell(10000, array('gridSpan' => 1, 'vMerge' => 'restart'))->addText('CERTIFICADO DE PUBLICACIÓN E INSERCIÓN EN PÁGINA WEB', $fuenteTituloTres, array('align'=>'center','spaceBefore' => 0, 'spaceAfter' => 0));
 
$seccion->addText('',$fuenteDosTituloTres,array('align'=>'center','spaceBefore' => 0, 'spaceAfter' => 0));


$documento->addTableStyle("estilo4", $estiloTablaDoss);
$tabla = $seccion->addTable("estilo4");

$row = $tabla->addRow();
$row->addCell(4000, array('gridSpan' => 1, 'vMerge' => 'restart'))->addText('No. de identificación:',$fuenteTituloTres, array('align'=>'center','spaceBefore' => 0, 'spaceAfter' => 0));
$row->addCell(6000, array('gridSpan' => 1, 'vMerge' => 'restart'))->addText($identificacionPredio, $fuenteDosTituloTres, array('align'=>'center','spaceBefore' => 0, 'spaceAfter' => 0));

$row = $tabla->addRow();
$row->addCell(4000, array('gridSpan' => 1, 'vMerge' => 'restart'))->addText('Nombre contribuyente o razón social',$fuenteTituloTres, array('align'=>'center','spaceBefore' => 0, 'spaceAfter' => 0));
$row->addCell(6000, array('gridSpan' => 1, 'vMerge' => 'restart'))->addText($nombrePredio, $fuenteTituloTres, array('align'=>'center','spaceBefore' => 0, 'spaceAfter' => 0));
$row = $tabla->addRow();
$row->addCell(4000, array('gridSpan' => 1, 'vMerge' => 'restart'))->addText('Nombre del acto administrativo',$fuenteTituloTres, array('align'=>'center','spaceBefore' => 0, 'spaceAfter' => 0));
$row->addCell(6000, array('gridSpan' => 1, 'vMerge' => 'restart'))->addText('Factura liquidación oficial', $fuenteTituloTres, array('align'=>'center','spaceBefore' => 0, 'spaceAfter' => 0));

$row = $tabla->addRow();
$row->addCell(4000, array('gridSpan' => 1, 'vMerge' => 'restart'))->addText('Numero de liquidación oficial',$fuenteTituloTres, array('align'=>'center','spaceBefore' => 0, 'spaceAfter' => 0));
$row->addCell(6000, array('gridSpan' => 1, 'vMerge' => 'restart'))->addText($facturaPredio, $fuenteDosTituloTres, array('align'=>'center','spaceBefore' => 0, 'spaceAfter' => 0));

$row = $tabla->addRow();
$row->addCell(4000, array('gridSpan' => 1, 'vMerge' => 'restart'))->addText('Fecha de liquidación oficial',$fuenteTituloTres, array('align'=>'center','spaceBefore' => 0, 'spaceAfter' => 0));
$row->addCell(6000, array('gridSpan' => 1, 'vMerge' => 'restart'))->addText($fechaFactura, $fuenteDosTituloTres, array('align'=>'center','spaceBefore' => 0, 'spaceAfter' => 0));

$row = $tabla->addRow();
$row->addCell(4000, array('gridSpan' => 1, 'vMerge' => 'restart'))->addText('Año gravable',$fuenteTituloTres, array('align'=>'center','spaceBefore' => 0, 'spaceAfter' => 0));
$row->addCell(6000, array('gridSpan' => 1, 'vMerge' => 'restart'))->addText($anio, $fuenteDosTituloTres, array('align'=>'center','spaceBefore' => 0, 'spaceAfter' => 0));
$row = $tabla->addRow();
$row->addCell(4000, array('gridSpan' => 1, 'vMerge' => 'restart'))->addText('Dependencia',$fuenteTituloTres, array('align'=>'center','spaceBefore' => 0, 'spaceAfter' => 0));
$row->addCell(6000, array('gridSpan' => 1, 'vMerge' => 'restart'))->addText('Secretaria de Hacienda Dirección de Impuestos, Rentas y Jurisdicción Coactiva', $fuenteDosTituloTres, array('align'=>'center','spaceBefore' => 0, 'spaceAfter' => 0));

$row = $tabla->addRow();
$row->addCell(4000, array('gridSpan' => 1, 'vMerge' => 'restart'))->addText('Fecha de Publicación',$fuenteTituloTres, array('align'=>'center','spaceBefore' => 0, 'spaceAfter' => 0));
$row->addCell(6000, array('gridSpan' => 1, 'vMerge' => 'restart'))->addText($diaDoc."/".$mesDoc."/".$anioDoc, $fuenteDosTituloTres, array('align'=>'center','spaceBefore' => 0, 'spaceAfter' => 0));
...
$micarpeta = '../PROCESO_FISCALIZACION/'.$idPredioFull.'/PUBLICACION';
if (!file_exists($micarpeta)) {
    //mkdir("../PROCESO_FISCALIZACION/".$idPredioFull, 0700);
    mkdir("../PROCESO_FISCALIZACION/".$idPredioFull."/PUBLICACION", 0700);
}
$objWriter->save("../PROCESO_FISCALIZACION/".$idPredioFull."/PUBLICACION"."/".$identificacionPredio."_".$facturaPredio.".docx");

// Convierte a PDF
Settings::setPdfRendererName(Settings::PDF_RENDERER_TCPDF);
Settings::setPdfRendererPath('./tcpdf');

$phpWord = IOFactory::load("../PROCESO_FISCALIZACION/".$idPredioFull."/PUBLICACION"."/".$identificacionPredio."_".$facturaPredio.".docx", 'Word2007');
$phpWord->save("../PROCESO_FISCALIZACION/".$idPredioFull."/PUBLICACION"."/".$identificacionPredio."_".$facturaPredio.".pdf", 'PDF');
