...
<!--
				...
				<button type="button" class="btn btn-outline-success" onclick="nota.crearDocumentos()">Iniciar Investigación</button>
			-->
			</div>
		</div>
		...
		<script src="../core/informeExogenas.js"></script>
